    ...
    internal sealed class SuspensionManager
    {
        ...
        public static async Task SaveAsync()
        {
            try
            {
                ...
                string serializedSessionState = StateSerializationHelper.GetSerializedToString(_sessionState);

                // Get an output stream for the SessionState file and write the state asynchronously
                StorageFile file = await ApplicationData.Current.LocalFolder.CreateFileAsync(sessionStateFilename, CreationCollisionOption.ReplaceExisting);
                await FileIO.WriteTextAsync(file, serializedSessionState);
            }
            catch (Exception e)
            {
        ...
        public static async Task RestoreAsync(String sessionBaseKey = null)
        {
            ...
            try
            {
                ...
                var serializedSessionState = await FileIO.ReadTextAsync(file);
                _sessionState = StateSerializationHelper.GetDeserializedObject<Dictionary<string, object>>(serializedSessionState);
